...
def create_qr(url: str) -> str:
    """
    Generate a QR code for the given URL and save it as 'qr_code.png'.
...
def main():
    ...
    website = "https://microsoft.benevity.org/campaigns/donate/92766"
    fname = create_qr(website)
    print(" Completed")
