...
def msft_generate_chat_response(query):
    ...
    prompt = f"""
    You are an OpenUSD 3D designer AI assistant specialized in generating Universal Scene Description (USD) code.

    IMPORTANT: Always generate actual OpenUSD code for 3D scenes. Format your response as follows:
    1. Brief explanation of what you're creating
    2. Complete OpenUSD code in ```usda code blocks
    3. Additional tips or variations if helpful
    ...
    Always include working OpenUSD code in your response.
    """
...
def process_usd_request(user_input: str):
    ...
    with st.spinner("🏗️ Generating OpenUSD code for your 3D scene..."):
        try:
